...
def test_cache_manager():
    ...
    try:
        from streamlit_infrastructure.cache import get_cache_manager
...
def test_prompt_manager():
    ...
    try:
        from streamlit_infrastructure.prompts import get_prompt_manager
...
def test_database_models():
    ...
    try:
        ...
        from streamlit_infrastructure.database.models import Analysis, AgentOutput, Base
...
def test_repositories():
    ...
    try:
        ...
        from streamlit_infrastructure.repositories import AnalysisRepository, AgentOutputRepository
        from streamlit_infrastructure.repositories.base_repository import BaseRepository
