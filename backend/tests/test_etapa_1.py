...
def test_database_connection():
    ...
    try:
        from streamlit_infrastructure.database import get_db_connection
        ...
        from streamlit_infrastructure.database.models import Analysis, AgentOutput
...
def test_analysis_service():
    ...
    try:
        from streamlit_infrastructure.services import AnalysisService
        import tempfile
        import time
